...
class MCPClient:
    ...
    def execute_tool(self, tool_name: str, arguments: Dict[str, Any], user_request_id: Optional[str] = None, selected_nifi_server_id: Optional[str] = None, action_id: Optional[str] = None) -> Any:
        """
        Execute an MCP tool.
        ...
        try:
            result = execute_mcp_tool(tool_name, arguments, selected_nifi_server_id, user_request_id=user_request_id, action_id=action_id)
