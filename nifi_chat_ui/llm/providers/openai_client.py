...
class OpenAIClient(LLMProvider):
    ...
    def send_message(
        ...
        self.logger.bind(interface="llm", direction="request", data=llm_request_data, user_request_id=user_request_id).debug("Calling OpenAI LLM")
        ...
        try:
            ...
            self.logger.bind(interface="llm", direction="response", data=llm_error_data, user_request_id=user_request_id).debug("Received error from OpenAI LLM")
            raise
